    ...
    <div class="grid grid-cols-2">
        ...
        <div class="justify-item-end flex flex-row-reverse">
            ...
            <div class="relative">
                ...
                <input wire:model.live='search' type="search" id="default-search" class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-red-500 focus:border-red-500 " placeholder="Buscar marcas" required />
            </div>
        </div>
    </div>
