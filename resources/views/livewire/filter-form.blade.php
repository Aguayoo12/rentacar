            ...
            <div class="flex items-center">
                <div class="flex flex-col w-full">
                    <div class="relative">
                        ...
                        <input min="{{ $now }}" max="{{ $endDate }}" required wire:model.live="initDate" name="start" type="date" class="bg-gray-50 border border-gray-900 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full ps-10 p-2.5 " placeholder="Selecciona fecha de fin">
                    </div>
                </div>
                ...
                <div class="flex flex-col w-full">
                    <div class="relative w-full">
                        ...
                        <input required wire:model.live="endDate" min="{{ $initDate }}" name="end" type="date" class="bg-gray-50 border border-gray-900 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full ps-10 p-2.5 " placeholder="Selecciona fecha de fin">
                    </div>
                </div>
            </div>
