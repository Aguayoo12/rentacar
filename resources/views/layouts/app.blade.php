...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <footer class="w-full pt-4 bg-slate-950">
        ...
        <div class="bg-red-500 p-2"><span class="text-lg text-white text-center block">©<a href="">RentaCar</a> 2024, All rights reserved.</span></div>
    </footer>
