<x-app-layout>
    <div class="relative bg-cover bg-no-repeat bg-center" style="background-image: url('storage/img/banner.jpg')">
        ...
        <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-32">
            <div class="relative max-w-7xl sm:mx-auto sm:text-center">
                <h1 class="mb-6 font-sans text-4xl text-center font-bold tracking-tight text-white sm:text-5xl sm:leading-none merriweather-black-italic">
                    ADMINISTRADOR DE <span class="rounded-md pe-2 text-white bg-red-500">RESERVAS</span>   
                </h1>
            </div>
        </div>
    </div>
    @livewire('reservas-admin');
</x-app-layout>